...
export default function About() {
  ...
  const handlePrint = async () => {
    if (!printRef.current || !buttonRef.current) return;

    buttonRef.current.style.visibility = 'hidden'; // Resume button 숨기기
  ...
  return (
    <div className='p-4 md:mx-20' ref={printRef}>
            ...
            <div className='flex flex-col gap-8'>
              ...
              <div className='relative'>
                ...
                <div className='flex flex-col gap-3'>
                  ...
                  <ul className='flex flex-col gap-2 text-muted-foreground list-disc list-outside pl-5'>
